...
class FluentSession extends AbstractFluentAdapter implements SessionInterface
{
     ...
     *
     * @return array Array of \EluminaElearning\OAuth2\Server\Entity\ScopeEntity
     */
     ...
     * @param \EluminaElearning\OAuth2\Server\Entity\ScopeEntity $scope The scopes ID might be an integer or string
     *
     * @return void
     */
