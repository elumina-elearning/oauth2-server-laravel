...
namespace EluminaElearning\OAuth2Server;

use EluminaElearning\OAuth2\Server\AuthorizationServer as Issuer;
use EluminaElearning\OAuth2\Server\Exception\AccessDeniedException;
use EluminaElearning\OAuth2\Server\ResourceServer as Checker;
use EluminaElearning\OAuth2\Server\TokenType\TokenTypeInterface;
use EluminaElearning\OAuth2\Server\Util\RedirectUri;
use EluminaElearning\OAuth2Server\Exceptions\NoActiveAccessTokenException;
...
class Authorizer
{
     ...
     *
     * @var \EluminaElearning\OAuth2\Server\ResourceServer
     */
    protected $checker;
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\AuthorizationServer $issuer
     * @param \EluminaElearning\OAuth2\Server\ResourceServer $checker
     */
     ...
     * Get the issuer.
     *
     * @return \EluminaElearning\OAuth2\Server\AuthorizationServer
     */
     ...
     * Get the checker.
     *
     * @return \EluminaElearning\OAuth2\Server\ResourceServer
     */
     ...
     *
     * @throws \EluminaElearning\OAuth2Server\Exceptions\NoActiveAccessTokenException
     *
     ...
     *
     * @param \EluminaElearning\OAuth2\Server\TokenType\TokenTypeInterface $tokenType
     */
